...
std::tuple<bool, std::vector<Node>> Dijkstra::Plan(const Node& start, const Node& goal) {
...
std::vector<Node> Dijkstra::ConvertClosedListToPath(std::unordered_set<Node, NodeIdAsHash, compare_coordinates>& closed_list, const Node& start, const Node& goal) {
